        ...
        private void TrackableCollectionChanged(object sender, NotifyCollectionChangedEventArgs e, string propertyName)
        {
            switch (e.Action)
            {
                case NotifyCollectionChangedAction.Add:
                    ...
                    {
                        //todo:impl̩menter la r̩cursivit̩ sur l'ajout des ̩lements dans la collection
                ...
                case NotifyCollectionChangedAction.Reset:
                    {
                        ...
                        // Tranf̬re les donn̩es de d̩part dans les ̩lements supprim̩s.
                ...
                case NotifyCollectionChangedAction.Replace:
                    {
                        // Comment g̩rer le cas d'un changement d'instance dans la liste ?
                    }
                    break;
            }
            UpdateChangeState();
    ...
    public partial class Actor : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public virtual string Serialize(System.Text.Encoding encoding)
        {
            ...
            try
            {
                ...
                System.Xml.XmlTextWriter xmlTextWriter = new System.Xml.XmlTextWriter(memoryStream, encoding);
