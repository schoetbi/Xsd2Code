...
namespace Xsd2Code.Extras
{
    ...
    public class ObjectChangeTracker : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public ObjectChangeTracker(object objectTracking)
        {
            objectTrackingField = objectTracking;
        }
        ...
        {
            var type = objectTrackingField.GetType();
            ...
            if (!isInitilizedField)
            {
                foreach (var propertyInfo in propertyies)
                {
                    ...
                    {
                        object o = propertyInfo.GetValue(objectTrackingField, null);
            ...
            if (objectTrackingEnabledField)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            PropertyValueStates[propertyName].State = string.IsNullOrEmpty(value as string) ? ObjectState.Unchanged : ObjectState.Modified;
                        }
                    }
                }
                UpdateChangeState();
    ...
    [CollectionDataContract(Name = "ObjectsOriginalToCollectionProperties", ItemName = "OriginalObjectsForProperty", KeyName = "CollectionPropertyName", ValueName = "OriginalObjects")]
    ...
    [CollectionDataContract(Name = "PropertyValueStatesDictionary", ItemName = "PropertyValueStates", KeyName = "Name", ValueName = "PropertyValueState")]
